"""
Gemma2 model with integrated transcoder adapters.

This module provides a Gemma2 model class that has transcoder layers built into
...
class Gemma2ConfigWithTranscoder(Gemma2Config):
    ...
    def __init__(self, transcoder_n_features=512, transcoder_dec_bias=False, **kwargs):
        ...
        Args:
            ...
            **kwargs: Other Gemma2Config parameters
        """
        ...
        self.architectures = ["Gemma2ForCausalLMWithTranscoder"]


class Gemma2MLPWithTranscoder(Gemma2MLP):
    """Gemma2 MLP with integrated transcoder branch."""
...
def register_gemma2_transcoder():
    """Register Gemma2 transcoder model with transformers AutoModel."""
    import transformers
    setattr(transformers, "Gemma2ForCausalLMWithTranscoder", Gemma2ForCausalLMWithTranscoder)


register_gemma2_transcoder()
